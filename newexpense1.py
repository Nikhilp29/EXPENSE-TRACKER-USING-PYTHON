...
class ExpenseTrackerApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.date_entry = DateEntry(self.frame_input, font=("Helvetica", 12), width=15, date_pattern='yyyy-mm-dd')  # Use DateEntry widget
    ...
    def add_expense(self):
        ...
        if expense and date:
            ...
            cursor.execute("INSERT INTO expenses (amount, item_description, category, expense_date) VALUES (%s, %s, %s, %s)",
                            (expense, item, category, date))
